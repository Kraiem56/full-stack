...
import { updateUserProfile } from "../component/Redux/actions/userActions.js";
import { connect } from "react-redux";
import { logout } from "../component/Redux/actions/userActions";
        ...
        {!this.state.loading ? (
          <Row>
            <Col md={4}>
              ...
              <Button onClick={this.logout} className='w-100' style={{marginTop:"5px"}}>Layout</Button>
              </Form>
            </Col>
           {!userInfo.isAdmin ? (<Col md={8}>
              <h4>My Orders</h4>
              ...
              <div>
                   {/* <Link to='/admin/userlist'>
                    ...
                    <Link to='/admin/userlist'>
                        ...
                        <th>Products</th>
                    <Link to='/admin/productslist'>
                        <th><Button style={{marginTop:"5px"}}>Modifier</Button></th>
                    </Link>
                        </tr>
                        <tr>
                        <th className="Listeadmin">Orders</th>
                        <Link to='/orderslist'>
